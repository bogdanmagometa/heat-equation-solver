...
class SirenWrapper(nn.Module):
    def __init__(self, siren):
        ...
        self.siren = siren
    def forward(self, x):
        return self.siren(x)[0]

def make_siren(inpt_dim, hidden_feature, hidden_layers, out_features, first_omega_0=30):
    siren = Siren(inpt_dim, hidden_feature, hidden_layers, out_features, first_omega_0=first_omega_0, outermost_linear=True)    
    
    # init_siren(siren)

    return SirenWrapper(siren)
